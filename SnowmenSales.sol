...
contract SnowmenSales is Ownable, ERC1155Holder { 
    ...
    event onERC1155BatchReceivedExcuted(
        address operator,
        address from,
        uint256 id,
        uint256 value
    ...
    constructor(address snowmenErc1155, address snowmenErc20) Ownable(msg.sender) {
    ...
    emit onERC1155BatchReceivedExcuted(operator, from, id, value);
